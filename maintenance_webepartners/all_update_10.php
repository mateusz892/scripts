...
$sql = "UPDATE `jos_get_xml`"
."SET categoryOne='Sukienki-asymetryczne'"
...
$sql = "UPDATE `jos_get_xml`"
."SET categoryOne='Sukienki-do-pracy'"
."WHERE ((name LIKE '%sukienka %'))"
...
$sql = "UPDATE `jos_get_xml`"
."SET categoryOne='Sukienki-dresowe'"
."WHERE ((name LIKE '%sukienka %'))"
...
$sql = "UPDATE `jos_get_xml`"
."SET categoryOne='Sukienki-dzinsowe'"
."WHERE ((name LIKE '%sukienka %'))"
...
$sql = "UPDATE `jos_get_xml`"
."SET categoryOne='Sukienki-gorsetowe'"
."WHERE ((name LIKE '%sukienka %'))"
...
$sql = "UPDATE `jos_get_xml`"
."SET categoryOne='Sukienki-koktajlowe'"
."WHERE ((name LIKE '%sukienka %'))"
...
$sql = "UPDATE `jos_get_xml`"
."SET categoryOne='Sukienki-koronkowe'"
."WHERE ((name LIKE '%sukienka %'))"
...
$sql = "UPDATE `jos_get_xml`"
."SET categoryOne='Sukienki-koszulowe'"
."WHERE ((name LIKE '%sukienka %'))"
