...
$sql = "UPDATE `jos_get_xml`"
."SET subcategoryOne='Botki-azurowe'"
...
$sql = "UPDATE `jos_get_xml`"
."SET subcategoryOne=''"
."WHERE (((name LIKE '%dziecięc%') OR (description LIKE '%dziecięc%') OR (name LIKE '%dzieck%') OR (description LIKE '%dzieck%') OR (name LIKE '%dziewczę%') OR (description LIKE '%dziewczę%')) AND (subcategoryOne='Botki-azurowe'))"
."AND canUpdate!='tak'"
;
...
$sql = "UPDATE `jos_get_xml`"
."SET subcategoryOne='Botki-na-koturnie'"
."WHERE ((name LIKE '%botki %'))"
."AND ((name LIKE '%na koturn%') OR (description LIKE '%na koturn%'))"
."AND canUpdate!='tak'"
."AND subcategoryOne=''"
...
$sql = "UPDATE `jos_get_xml`"
."SET subcategoryOne=''"
."WHERE (((name LIKE '%dziecięc%') OR (description LIKE '%dziecięc%') OR (name LIKE '%dzieck%') OR (description LIKE '%dzieck%') OR (name LIKE '%dziewczę%') OR (description LIKE '%dziewczę%')) AND (subcategoryOne='Botki-na-koturnie'))"
."AND canUpdate!='tak'"
;
