...
$sqlFilterone = "UPDATE `jos_get_xml`"
."SET filterone='tak'"
...
for($i=1;$i<=$amount_all;$i++) {
	...
	$sklep_name = $all[$i-1];
	$sklep_name = str_replace( 'amp;', '', $sklep_name);
	$sklep_name = str_replace( ';', '', $sklep_name);
	$alias = $sklep_name;
...
for($i=1;$i<=$amount_all;$i++) {
	...
	$marka_name = $all[$i-1];
	$marka_name = str_replace( 'amp;', '', $marka_name);
	$marka_name = str_replace( ';', '', $marka_name);
	$alias = $marka_name;
	$cenzura = array('ą', 'ć', 'ł', 'ó', 'ś', 'ę', 'ń', 'ż', 'ź','Ą', 'Ć', 'Ł', 'Ó', 'Ś', 'Ę', 'Ń', 'Ż', 'Ź' );
	$zamiana = array('a', 'c', 'l', 'o', 's', 'e', 'n', 'z', 'z','A', 'C', 'L', 'O', 'S', 'E', 'N', 'Z', 'Z' );
	$alias=str_replace( $cenzura, $zamiana, $alias);
...
for($i=1;$i<=$amount_all;$i++) {
	...
	$kolor_name = $all[$i-1];
	$kolor_name = str_replace( 'amp;', '', $kolor_name);
	$kolor_name = str_replace( ';', '', $kolor_name);
	$alias = $kolor_name;
	$cenzura = array('ą', 'ć', 'ł', 'ó', 'ś', 'ę', 'ń', 'ż', 'ź','Ą', 'Ć', 'Ł', 'Ó', 'Ś', 'Ę', 'Ń', 'Ż', 'Ź' );
	$zamiana = array('a', 'c', 'l', 'o', 's', 'e', 'n', 'z', 'z','A', 'C', 'L', 'O', 'S', 'E', 'N', 'Z', 'Z' );
	$alias=str_replace( $cenzura, $zamiana, $alias);
...
for($i=1;$i<=$amount_all;$i++) {
	...
	$rozmiar_name = str_replace( 'amp;', '', $rozmiar_name);
	$rozmiar_name = str_replace( ';', '', $rozmiar_name);
	$alias = $rozmiar_name;
	$cenzura = array('ą', 'ć', 'ł', 'ó', 'ś', 'ę', 'ń', 'ż', 'ź','Ą', 'Ć', 'Ł', 'Ó', 'Ś', 'Ę', 'Ń', 'Ż', 'Ź' );
	$zamiana = array('a', 'c', 'l', 'o', 's', 'e', 'n', 'z', 'z','A', 'C', 'L', 'O', 'S', 'E', 'N', 'Z', 'Z' );
	$alias=str_replace( $cenzura, $zamiana, $alias);
