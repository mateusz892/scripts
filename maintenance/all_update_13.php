...
."WHERE ((categoryOne LIKE '%Sukienki-dresowe%')"
...
//."OR (categoryOne LIKE '%Sukienki-na-sylwestra%')"
."OR (categoryOne LIKE '%Sukienki-letnie%'))"
//."OR (categoryOne LIKE '%Sukienki-na-studniowke%')"
