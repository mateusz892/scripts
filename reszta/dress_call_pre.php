...
."AND ((name LIKE '%świadko%') OR (description LIKE '%świadko%') OR (name LIKE '%świade%') OR (description LIKE '%świade%'))"
...
."AND ((name LIKE '%indyjs%') OR (description LIKE '%indyjs%'))"
...
."AND ((name LIKE '%bierzmo%') OR (description LIKE '%bierzmo%'))"
...
."AND ((name LIKE '%starszy%') OR (description LIKE '%starszy%') OR (name LIKE '%starsze%') OR (description LIKE '%starsze%'))"
...
."AND ((name LIKE '%sweter%') OR (description LIKE '%sweter%') OR (name LIKE '%swetro%') OR (description LIKE '%swetro%'))"
...
."AND ((name LIKE '%bandaż%') OR (description LIKE '%bandaż%'))"
